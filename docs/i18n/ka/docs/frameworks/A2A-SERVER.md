...
title: "OmniRoute A2A სერვერის დოკუმენტაცია"
version: 3.8.40
lastUpdated: 2026-06-28
---

# OmniRoute A2A სერვერის დოკუმენტაცია

> აგენტებს შორის ურთიერთქმედების პროტოკოლი v0.3 — OmniRoute, როგორც ინტელექტუალური მარშრუტიზაციის აგენტი
...
- **REST** მისამართზე `/api/a2a/*`, საინფორმაციო დაფებისა და ხელსაწყოებისთვის (სტატუსი, ამოცანების სია, გაუქმება).

ამოცანებს აკონტროლებს `A2ATaskManager` (`src/lib/a2a/taskManager.ts`, ნაგულისხმევად 5-წუთიანი TTL). უნარების გადამისამართება ხდება `A2A_SKILL_HANDLERS`-ის მეშვეობით, ფაილში `src/lib/a2a/taskExecution.ts`.

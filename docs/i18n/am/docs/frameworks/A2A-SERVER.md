...
title: "የOmniRoute A2A አገልጋይ ሰነድ"
version: 3.8.40
lastUpdated: 2026-06-28
---

# የOmniRoute A2A አገልጋይ ሰነድ

> ከኤጀንት-ወደ-ኤጀንት ፕሮቶኮል v0.3 — OmniRoute እንደ ብልህ የማስተላለፊያ ኤጀንት

የA2A በይነገጽ ሁለት ገጽታዎች አሉት፦

- **JSON-RPC 2.0** በ`POST /a2a` (ዋናው መግቢያ ነጥብ፣ በ`src/app/a2a/route.ts` ውስጥ የተገለጸ)።
- **REST** በ`/api/a2a/*` ሥር፣ ለዳሽቦርዶች እና መሣሪያዎች (ሁኔታ፣ የተግባር ዝርዝር፣ ስረዛ)።

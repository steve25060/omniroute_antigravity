...
title: "CLI ඒකාබද්ධකරණ — ඕනෑම කේතකරණ CLI එකක් OmniRoute වෙත යොමු කරන්න"
version: 3.8.50
...
කේතකරණ CLI එකක් (Codex, Claude Code, OpenCode, Cline, …) එහි පසුබිම් සේවාව ලෙස OmniRoute භාවිත කිරීමට වින්යාස කරන `setup-*` විධාන පෙළක් OmniRoute සමඟ සපයනු ලැබේ — එම නිසා මෙවලම **එක්** අන්ත ලක්ෂ්යයක් සමඟ සන්නිවේදනය කරන අතර OmniRoute ස්වයංක්රීය විකල්පයකට මාරුවීම සමඟ නිවැරදි සැපයුම්කරු වෙත යොමු කරයි. සෑම විධානයක්ම ක්රියාත්මක වෙමින් පවතින OmniRoute එකකින් (දේශීය හෝ දුරස්ථ) **සජීවී** ආකෘති නාමාවලිය කියවා, මෙවලමට අදාළ වින්යාස ගොනුව **ඔබගේ** යන්ත්රයේ ලියයි. මෙවලම සහාය දක්වන සෑම අවස්ථාවකම API යතුර පරිසර විචල්යයක් මඟින් යොමු කෙරේ. මෙවලමට දේශීය පරිසර ගොනුවක් ස්ථිරව සුරකින විධාන පහතින් සඳහන් කර ඇත.

කිසිදු වින්යාසයක් නොලියා, නිවැරදි පරිසර අගයන් ඇතුළත් කර `claude`, `codex`, `aider`, `goose`, `opencode`, `qwen` හෝ `gemini` ආරම්භ කරන පොදු දියත්කරණයක් — `omniroute run <target>` — ද ඇත. ඉලක්ක සහ ඒවායේ අන්වර්ථ නාම කැනොනිකල් මැනිෆෙස්ටය වන `bin/cli/cli-manifest.mjs` වෙතින් පැමිණේ (`claude-code|cc|anthropic`, `codex-cli|openai-codex|openai`, `goose-cli`, `open-code`, `qwen-code`, `gemini-cli`), එමෙන්ම `omniroute completion` මඟින් එම මැනිෆෙස්ටයෙන්ම ලබාගත් ඉලක්ක වචන පිරිනමයි. පැරණි, එක් එක් මෙවලමට වෙන් වූ දියත්කරණ — `omniroute launch` (Claude Code) සහ `omniroute launch-codex` (Codex) — තවදුරටත් ලබාගත හැක.

එම දේශීය/දුරස්ථ සන්දර්භයෙන්ම සැපයුම්කරුවන් ඇතුළත් කිරීමද කළ හැක. පහත API-ප්රමුඛ විධාන මඟින් කළමනාකරණ සත්යාපනය සැපයුම්කරුගේ අක්තපත්රවලින් වෙන්ව තබන අතර ව්යුහගත ප්රතිදානයක කිසිවිටෙක අක්තපත්රයක් මුද්රණය නොකරයි:
...
ස්ක්රිප්ට් සඳහා `--credential-stdin` හෝ `--credential-env` වඩාත් සුදුසුය; පාලිත දේශීය භාවිතය සඳහා `--credential` තවදුරටත් රඳවා ඇත. අන්තර්ක්රියාකාරී නොවන ටර්මිනලයකදී `providers remove` සඳහා `--yes` අවශ්ය වන අතර, විධාන පහම සක්රිය සන්දර්භයට හෝ ගෝලීය `--base-url`/`--api-key` විකල්පවලට අනුව ක්රියා කරයි.

වඩාත් සවිස්තර ඒකාබද්ධකරණ දෙක සඳහා එක් වරක් පමණක් අතින් ලියන මූලික සැකසුම පිළිබඳව, එක් එක් මෙවලම සඳහා වන සවිස්තර මාර්ගෝපදේශ බලන්න:

- [Claude Code වින්යාසය](./CLAUDE-CODE-CONFIGURATION.md)
- [Codex CLI වින්යාසය](./CODEX-CLI-CONFIGURATION.md)
- [දුරස්ථ ප්රකාරය](./REMOTE-MODE.md) — ඔබේ ලැප්ටොප් පරිගණකයෙන් දුරස්ථ OmniRoute එකක් (VPS / Tailnet) මෙහෙයවන්න
- [VS Code Copilot Chat](./VSCODE-COPILOT.md) — OmniCopilot දිගුව; එයට සංස්කාරකය තුළින්ම ඔබ වෙනුවෙන් මෙම
  `setup-*` විධාන ක්රියාත්මක කිරීමටද හැකිය
